...
namespace CommonHelper
{
    public static class INIHelper
    {
        ...
        public static int ReadInteger(string keyName, string path, string sectionName = Constants.INI_SectionName, int defaultValue = 0)
        {
            return GetPrivateProfileInt(sectionName, keyName, defaultValue, path);
        }
        ...
        public static void WriteInteger(string keyName, int value, string path, string sectionName = Constants.INI_SectionName)
        {
            WritePrivateProfileString(sectionName, keyName, value.ToString(), path);
