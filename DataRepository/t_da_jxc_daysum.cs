namespace DataRepository
{
    ...
    public partial class t_da_jxc_daysum
    {
        [Key]
        [Column(Order = 0)]
        [StringLength(20)]
        ...
        [Column(TypeName = "numeric")]
        public decimal? pos_cost_amt { get; set; }

        [Column(TypeName = "numeric")]
        public decimal? so_cost_amt { get; set; }
        ...
        [Column(TypeName = "numeric")]
        public decimal? pos_sp_qty { get; set; }

        [Column(TypeName = "numeric")]
        public decimal? pos_sp_amt { get; set; }

        [Column(TypeName = "numeric")]
        public decimal? so_sp_qty { get; set; }

        [Column(TypeName = "numeric")]
        public decimal? so_sp_amt { get; set; }

        [Column(TypeName = "numeric")]
        public decimal? io_qty { get; set; }

        [Column(TypeName = "numeric")]
        public decimal? io_amt { get; set; }
    }
}
